        ...
        <div className="page5">
            ...
            <div className="page52">
                ...
                <div className="page523">
                    <div className="page5231">Nội dung</div>
                    <div className="page5232">Sợi lẫn màu tạp</div>
                    <div className="page5232">Sợi lẫn màu tạp</div>
                    <div className="page5232">Sợi lẫn màu tạp</div>
                    <div className="page5232">Sợi lẫn màu tạp</div>
                    <div className="page5232">Sợi lẫn màu tạp</div>
                ...
                <div className="page523">
                    <div className="page5231">Ngày khiếu nại</div>
                ...
                <div className="page522">
                    ...
                    <div className="page5222">Chưa xử lý</div>
                    <div className="page5222">Chưa xử lý</div>
                    <div className="page5222">Chưa xử lý</div>
                    <div className="page5222">Chưa xử lý</div>
                    <div className="page5222">Chưa xử lý</div>
